    ...
    if ($bNeedToLoadLocation && isset($aInputData['region_data']['location'])){
        if (isset($aInputData['region_data']['location']['place_id'])){
            $sResult = file_get_contents(
                'https://maps.googleapis.com/maps/api/geocode/json?language=ru&key=AIzaSyBdSfW3GMilVd2t6muHf8oqwpp6vyibp70&place_id='.$aInputData['region_data']['location']['place_id']
            );
