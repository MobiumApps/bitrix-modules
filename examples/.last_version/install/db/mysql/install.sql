...
INSERT IGNORE INTO `mobium_registration_fields` VALUES
...
CREATE TABLE IF NOT EXISTS `mobium_user_token`(
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `BODY` varchar(50) COLLATE cp1251_general_ci NOT NULL,
  `CREATED_AT` int(11) NOT NULL,
  `LIFETIME` int(11) DEFAULT 0,
  `TYPE` varchar(50) COLLATE cp1251_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mobium_delivery_type_assoc`(
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `ACTIVE` char(1) COLLATE cp1251_general_ci NOT NULL DEFAULT 'N',
  `DELIVERY_SERVICE_ID_BITRIX` varchar(100) COLLATE cp1251_general_ci NOT NULL,
  `DELIVERY_SERVICE_ID_MOBIUM` varchar (100) COLLATE cp1251_general_ci NOT NULL,
  `DELIVERY_SERVICE_AREA_ID` varchar(100) collate cp1251_general_ci NOT NULL,
  PRIMARY KEY (`ID`)
) DEFAULT CHARSET=cp1251 COLLATE=cp1251_general_ci;

CREATE TABLE IF NOT EXISTS `mobium_offers_export_props`(
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `EXPORT_PROP_ID` VARCHAR(255) COLLATE cp1251_general_ci NOT NULL,
  `EXPORT_PROP` char(1) COLLATE cp1251_general_ci NOT NULL DEFAULT 'Y',
  `EXPORT_NAME` varchar(255) COLLATE cp1251_general_ci NULL,
  `EXPORT_SORT` int(11) NOT NULL DEFAULT 500,
  `PROP_IS_VENDOR_CODE` char(1) COLLATE cp1251_general_ci NOT NULL DEFAULT 'N',
  `PROP_IS_TOOLTIP` char(1) COLLATE cp1251_general_ci NOT NULL DEFAULT 'N',
