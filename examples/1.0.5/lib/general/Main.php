			...
			switch ($aTempField['cabinet_field_type']) {
				...
				case 'bonus_field':
					...
					if ($aCardData != false) {
						...
						$aBonusField['available_proportion'] = $aCardData["BONUS_AVAILABLE"];
					} else {
						$bAddToResult = false;
					}
					break;
...
//		}
	...
	function generateBarcode($code): string
	{
		...
		$sContent = $oGenerator->getBarcode($code, $oGenerator::TYPE_CODE_128, 2, 70);
